                ...
                <tbody>
                  ...
                  ?>
                      <tr>
                        ...
                        <td><button class="btn btn-primary reply" <?php if($leave['status'] == 'Approved'){echo 'disabled';}?> type="button" data-id="<?php echo $leave['id']; ?>" data-bs-target="#viewModal" data-bs-toggle="modal">Reply</button></td>
                      </tr>
                              ...
                              <div class="container" id="reply">
                                ...
                                <form action="../connection/leave_control.php" method="post">
                                  ...
                                  <div class="form-floating">
                                    <textarea class="form-control"  required placeholder=" " maxlength="50" id="response2" name="response2"></textarea>
                                    <label for="response2">Comment</label>
                                  </div>
                                  <div class="modal-footer">
                                    <input type="hidden" name="idno" id="idno" value="">
                                    <input type="hidden" name="total" id="total" value="">
                                    <input type="hidden" name="userid" id="userid" value="">
                                    <input type="submit" class="btn btn-success px-3" name="approve2" value="Approve">
                                    <input type="submit" class="btn btn-danger" name="reject2" value="Reject">
                                  </div>
